  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        game: "bg-primary text-primary-foreground font-bold shadow-lg neon-box hover:scale-105 active:scale-95 font-fredoka tracking-wide",
        gameSecondary: "bg-card/80 backdrop-blur-sm border-2 border-primary/50 text-foreground hover:border-primary hover:bg-card",
        icon: "bg-card/60 backdrop-blur-sm border border-border hover:bg-card hover:border-primary text-foreground",
      },
      size: {
